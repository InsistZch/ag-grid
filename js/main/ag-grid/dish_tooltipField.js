    ...
    init(params){
        if(params.data.configure){
            ...
            <div class="el_sales_main">
                <div class="el_sales_left" style="${left_width}%"></div>
                <div class="center_sales el_sales_minRomax" data-center="${(average * 100).toFixed(1)}%" title="业内平均成本比例"></div>
                <div class="el_sales_right"></div>
                <div class="min_sales el_sales_minRomax" data-min="${(min * 100).toFixed(1)}%" title="业内最小成本比例"></div>
                <div class="max_sales el_sales_minRomax" data-max="${(max * 100).toFixed(1)}%" title="业内最大成本比例"></div>
